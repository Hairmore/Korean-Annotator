...
def main():
    ...
    subparser.add_argument('--lr', type=float, help='which BERT model to use')
    subparser.add_argument('--lr-rate', type=int, help='which BERT model to use')
    subparser.add_argument('--batch-size', type=int, help='which BERT model to use')
    subparser.add_argument('--epochs', type=int, help='which BERT model to use')
    subparser.add_argument('--update-steps', type=int, help='which BERT model to use')
